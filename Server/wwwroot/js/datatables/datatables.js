			...
			"fnInit": function( oSettings, nPaging, fnDraw ) {
				...
				$(nPaging).append(
					'<ul class="pagination" style="direction:ltr">'+
						'<li class="prev disabled"><a href="#" class="btn btn-primary"><span class="bi bi-arrow-left-square"></span></a></li>'+
						'<li class="next disabled"><a href="#" class="btn btn-primary"><span class="bi bi-arrow-right-square"></span></a></li>'+
					'</ul>'
				);
				var els = $('a', nPaging);
			...
			"fnUpdate": function ( oSettings, fnDraw ) {
				...
				for ( i=0, ien=an.length ; i<ien ; i++ ) {
					...
					for ( j=iStart ; j<=iEnd ; j++ ) {
						...
						$('<li ' + sClass +'><a href="#" class="btn btn-light">'+j+'</a></li>')
